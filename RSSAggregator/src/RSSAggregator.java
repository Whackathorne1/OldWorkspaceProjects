...
public final class RSSAggregator {
    ...
    private static int getChildElement(XMLTree xml, String tag) {
        ...
        int index = -1;
        //tells whether the current tag has a child by giving the index a value of -1
    ...
    private static void processFeed(String url, String file, SimpleWriter out) {
        ...
        //has version attribute, and attribute value = 2.0)
        ...
        if (xml.label().equals("rss") && xml.hasAttribute("version")
            ...
            out.println("Invalid RSS Feed: " + file);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        //ask user for the XML file with all of the RSS feeds
        out.println("Enter the XML file: ");
        String xmlFileUrl = in.nextLine();
        XMLTree userXML = new XMLTree1(xmlFileUrl);

        //ask for the output file
        out.println("output file name including \".html\" ");
        String fileName = in.nextLine();
        SimpleWriter index = new SimpleWriter1L(fileName);

        //initialize values of attributes for each tag
        String indexTitle = userXML.attributeValue("title");

        //print header tags
        index.print("<html><head><title> " + indexTitle + " </title>");
        index.print("</head><body><h2> " + indexTitle + " </h2><ul>");

        //process the RSS list
        for (int i = 0; i < userXML.numberOfChildren(); i++) {
            if (userXML.child(i).label().equals("feed")) {
                String feedFile = userXML.child(i).attributeValue("file");
                String feedName = userXML.child(i).attributeValue("name");
                String feedURL = userXML.child(i).attributeValue("url");
                index.print("<li><a href=\"" + feedFile + "\">" + feedName
                        + "</a></li>");
