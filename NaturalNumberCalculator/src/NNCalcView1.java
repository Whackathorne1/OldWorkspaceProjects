...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
         ...
         */
        JPanel panel = new JPanel(new GridLayout(MAIN_BUTTON_PANEL_GRID_ROWS,
                MAIN_BUTTON_PANEL_GRID_COLUMNS));
        /*
         * Add the buttons to the main button panel, from left to right and top
         * to bottom
         */
        panel.add(this.bDigits[7]);
        panel.add(this.bDigits[8]);
        panel.add(this.bDigits[9]);
        panel.add(this.bAdd);
        panel.add(this.bDigits[4]);
        panel.add(this.bDigits[5]);
        panel.add(this.bDigits[6]);
        panel.add(this.bSubtract);
        panel.add(this.bDigits[1]);
        panel.add(this.bDigits[2]);
        panel.add(this.bDigits[3]);
        panel.add(this.bMultiply);
        panel.add(this.bDigits[0]);
        panel.add(this.bPower);
        panel.add(this.bRoot);
        panel.add(this.bDivide);
        /*
         * Create side button panel
         */
        JPanel bPanel = new JPanel(new GridLayout(SIDE_BUTTON_PANEL_GRID_ROWS,
                SIDE_BUTTON_PANEL_GRID_COLUMNS));
        /*
         * Add the buttons to the side button panel, from left to right and top
         * to bottom
         */
        bPanel.add(this.bClear);
        bPanel.add(this.bSwap);
        bPanel.add(this.bEnter);
        /*
         * Create combined button panel organized using flow layout, which is
         * simple and does the right thing: sizes of nested panels are natural,
         * not necessarily equal as with grid layout
         */
        JPanel fLayout = new JPanel(new FlowLayout());
        /*
